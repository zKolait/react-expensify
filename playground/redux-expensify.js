...
const expenseOne = store.dispatch(addExpense({ description: 'Rent', amount: 110, createdAt: 0 }))
const expenseTwo = store.dispatch(addExpense({ description: 'Coffee', amount: 100, createdAt: 20 }))
